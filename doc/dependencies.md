...
These are the dependencies currently used by Marketcoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/marketcoinnl
Keybase  - https://keybase.io/team/marketcoin/
