...
public:
    CMainParams() {
        ...
        */
        ...
        vSeeds.push_back(CDNSSeedData("dnsseed.marketcoin.nl", "dnsseed.marketcoin.nl")); //hosted at dns.marketcoin.nl
        vSeeds.push_back(CDNSSeedData("dnsseed2.marketcoin.nl", "dnsseed2.marketcoin.nl")); //hosted at vps.marketcoin.nl
        vSeeds.push_back(CDNSSeedData("ghost.marketcoin.nl", "ghost.marketcoin.nl")); // Michel van Kessel static node
        vSeeds.push_back(CDNSSeedData("node.marketcoin.io ", "node.marketcoin.io"));  // payMKT static node
