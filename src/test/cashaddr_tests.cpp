...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_valid)
{
    static const std::string CASES[] = {
        "prefix:x64nx6hz", "PREFIX:X64NX6HZ", "p:gpf8m4h7", "marketcoin:qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn",
        "mkttest:testnetaddress4d6njnut", "mktreg:555555555555555555555555555555555555555555555udxmlmrz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_invalid)
{
    static const std::string CASES[] = {
        ...
        "mktreg:555555555555555555x55555555555555555555555555udxmlmrz",
        "mktreg:555555555555555555555555555555551555555555555udxmlmrz", "pre:fix:x32nx6hz", "prefixx64nx6hz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_noprefix)
{
    static const std::pair<std::string, std::string> CASES[] = {
        {"marketcoin", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"}, {"prefix", "x64nx6hz"}, {"PREFIX", "X64NX6HZ"},
        {"p", "gpf8m4h7"}, {"marketcoin", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"},
        {"mkttest", "testnetaddress4d6njnut"}, {"mktreg", "555555555555555555555555555555555555555555555udxmlmrz"},
    };
