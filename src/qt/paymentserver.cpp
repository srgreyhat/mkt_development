...
const char* BIP71_MIMETYPE_PAYMENT = "application/marketcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/marketcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/marketcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click marketcoin: links
...
//
// OSX-specific way of handling marketcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in marketcoin: URIs
