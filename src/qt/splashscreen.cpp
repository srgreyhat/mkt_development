    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextMarketcoin   = QChar(0xA9)+QString(" %1-%2 ").arg(2014).arg(2018) + QString("The Marketcoin developers");
    QString copyrightTextBlackmore   = QChar(0xA9)+QString(" %1-%2 ").arg(2018).arg(COPYRIGHT_YEAR) + QString("The Marketcoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+10,copyrightTextMarketcoin);
