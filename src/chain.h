...
enum BlockStatus: uint32_t {
    ...
    BLOCK_HAVE_DATA          =    8, //!< full block available in mkt*.dat
...
public:
    ...
    //! Which # file this block is stored in (mkt?????.dat)
    int nFile;

    //! Byte offset within mkt?????.dat where this block's data is stored
